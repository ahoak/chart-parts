...
const FEMALE_COLOR = '#f781db'
const MALE_COLOR = '#80acf7'
const MALE_CODE = '1'
const FEMALE_CODE = '2'
const MALE_ACCENT_COLOR = '#005fae'
const FEMALE_ACCENT_COLOR = '#af0093'
